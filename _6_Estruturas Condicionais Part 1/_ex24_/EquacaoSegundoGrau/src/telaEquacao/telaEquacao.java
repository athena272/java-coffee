...
public class telaEquacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblXLinha1 = new javax.swing.JLabel();
        lblXLinha2 = new javax.swing.JLabel();
        ...
        jLabel1.setText("<html> X<sup>2</sup> + </htm>");
        ...
        lblB.setBackground(new java.awt.Color(0, 0, 102));
        lblB.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        lblB.setForeground(new java.awt.Color(255, 51, 51));
        lblB.setText("B");
        lblB.addHierarchyListener(new java.awt.event.HierarchyListener() {
            public void hierarchyChanged(java.awt.event.HierarchyEvent evt) {
                lblBHierarchyChanged(evt);
            }
        });
        ...
        lblDelta.setForeground(new java.awt.Color(51, 153, 0));
        lblDelta.setText("0");

        lblRaizes.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        lblRaizes.setForeground(new java.awt.Color(51, 153, 0));
        lblRaizes.setText("0");
        ...
        lblXLinha1.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        lblXLinha1.setForeground(new java.awt.Color(255, 51, 51));
        lblXLinha1.setText("0");

        lblXLinha2.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        lblXLinha2.setForeground(new java.awt.Color(255, 51, 51));
        lblXLinha2.setText("0");
        ...
        painelXLayout.setHorizontalGroup(
            ...
            .addGroup(painelXLayout.createSequentialGroup()
                ...
                .addGap(34, 34, 34)
                .addGroup(painelXLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblXLinha2)
                    .addComponent(lblXLinha1))
        ...
        painelXLayout.setVerticalGroup(
            ...
            .addGroup(painelXLayout.createSequentialGroup()
                .addGap(25, 25, 25)
                .addGroup(painelXLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(lblXLinha1))
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(painelX, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void lblBHierarchyChanged(java.awt.event.HierarchyEvent evt) {//GEN-FIRST:event_lblBHierarchyChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_lblBHierarchyChanged
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        // TODO add your handling code here:
        //Pegando valores dos spinneras
        int A = Integer.parseInt(txtA.getValue().toString());
        int B = Integer.parseInt(txtB.getValue().toString());
        int C = Integer.parseInt(txtC.getValue().toString());
        //Achar Delta
        int Delta = (int) (Math.pow(B, 2) - (4 * A *C));
        //escrever Delta na tela
        lblDelta.setText(Integer.toString(Delta));
        //Ver se delta é negativo ou positivo
        if (Delta < 0){
            lblRaizes.setText("Não existem Raízes Reais");
            painelX.setVisible(false);
        }
        else if (Delta == 0){
            lblRaizes.setText("Há apenas uma raíz real");
            //calcular o único valor real
            int x_linha1 = (int) (((-B) + Math.sqrt(Delta)) / 2 * A);
            //exibir único valor real
            lblXLinha1.setText(Integer.toString(x_linha1));
            //Zerar Segundo X
            lblXLinha2.setText("Não há");
            //Exibir painel
            painelX.setVisible(true);
            
        }
        else{
            //Saber se Delta tem raiz exata ou não
            int raizQ = (int) Math.sqrt(Delta);
            if (Math.pow(raizQ, 2) == Delta){
                lblRaizes.setText("<html>Existem 2 raízes reais <br>e Delta tem raiz exata</html>");
                //Se tiver vamos achar x 1 linha e x 2 linha
                //Formula de bhaskara
                int x_linha1 = (int) (((-B) + Math.sqrt(Delta)) / 2 * A); 
                //Formaula de bhaskara
                int x_linha2 = (int) (((-B) - Math.sqrt(Delta)) / 2 * A);
                //Enviar para tela
                lblXLinha1.setText(Integer.toString(x_linha1));
                lblXLinha2.setText(Integer.toString(x_linha2));
                //Deixar visível
                painelX.setVisible(true);
            }
            else {
                lblRaizes.setText("<html>Existem 2 raízes reais, <br>mas Delta não tem raiz exata.</html>");
                painelX.setVisible(false);
            }
    ...
    private javax.swing.JLabel lblXLinha1;
    private javax.swing.JLabel lblXLinha2;
