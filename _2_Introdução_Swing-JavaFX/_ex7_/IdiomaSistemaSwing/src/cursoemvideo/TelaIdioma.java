...
public class TelaIdioma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cursoemvideo/globo.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Dialog", 3, 20)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 51));
        jLabel2.setText("Idioma do meu Sistema:");

        lblLingua.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        lblLingua.setForeground(new java.awt.Color(51, 0, 0));
        lblLingua.setText("*Aperte no Botão");

        btnLingua.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        btnLingua.setText("Mostrar Idioma");
    ...
    private void btnLinguaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLinguaActionPerformed
        ...
        lblLingua.setText(idioma.getDisplayLanguage());
